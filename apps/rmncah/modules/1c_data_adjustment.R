    ...
    fluidRow(
        column(
          ...
          box(
            ...
            width = 12,
            fluidRow(
              column(3, selectizeInput(ns('k_anc'),
                                       label = i18n$t("title_adjust_anc_factor"),
                                       choices = k_factor_options)),
              column(3, selectizeInput(ns('k_delivery'),
                                       label = i18n$t("title_adjust_delivery_factor"),
                                       choices = k_factor_options)),
              column(3, selectizeInput(ns('k_vaccines'),
                                       label = i18n$t("title_adjust_vaccines_factor"),
                                       choices = k_factor_options)),
              column(3, selectizeInput(ns('k_opd'),
                                       label = i18n$t("title_adjust_opd_factor"),
                                       choices = k_factor_options))
            )
          )
        ),
